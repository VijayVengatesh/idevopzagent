...
func (l LinuxCollector) CpuUtilization(userID string) (*models.CpuUtilization, error) {
	// Get CPU percentage
...
func (l LinuxCollector) MemoryUtilization(userID string) (*models.MemoryUtilization, error) {
...
func (l LinuxCollector) DiskUtilization(userID string) (*models.DiskUtilization, error) {
