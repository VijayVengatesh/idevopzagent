...
func (l WindowsCollector) CpuUtilization(userID string) (*models.CpuUtilization, error) {
	// Get CPU percentage
...
func (l WindowsCollector) MemoryUtilization(userID string) (*models.MemoryUtilization, error) {
...
func (l WindowsCollector) DiskUtilization(userID string) (*models.DiskUtilization, error) {
	const path = "/" // Default mount point for Linux

	usedPercent, _, _, err := utils.GetDiskUsage(path)
	if err != nil {
